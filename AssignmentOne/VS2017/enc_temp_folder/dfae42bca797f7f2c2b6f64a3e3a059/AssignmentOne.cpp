...
int createVertexArrayObject(float x, float y, float z, float r, float g, float b)
{
    // A vertex is a point on a polygon, it contains positions and other data (eg: colors)
    glm::vec3 vertexArray[] = {
        glm::vec3(x,  y, -z),  // top right
        glm::vec3(r,  g, b),  // top right color (red)
...
int main(int argc, char*argv[])
{
    ...
    int vaoFrontBack = createVertexArrayObject(0.5f, 0.5f, 0.0f, 1.0f, 0.0f, 0.0f);
    int vaoTopBottom = createVertexArrayObject(0.5f, 0.0f, 0.5f, 0.0f, 1.0f, 0.0f);
    int vaoLeftRight = createVertexArrayObject(0.0f, 0.5f, 0.5f, 0.0f, 0.0f, 1.0f);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Draw Front-Back geometry
        glUseProgram(shaderProgram);
        glBindVertexArray(vaoFrontBack);
        glEnable(GL_CULL_FACE);

        //front face
        // triangle 1
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 0.5f));
        ...
        // triangle 1
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -0.5f));
        rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(1.0f, 1.0f, 0.0f));
        worldMatrix = translationMatrix * rotationMatrix;
        glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
        ...
        // Draw Top-Bottom geometry
        glUseProgram(shaderProgram);
        glBindVertexArray(vaoTopBottom);
        ...
        // triangle 1
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -0.5f, 0.0f));
        rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 1.0f));
        worldMatrix = translationMatrix * rotationMatrix;
        glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
        ...
        // Draw Left-Right geometry
        glUseProgram(shaderProgram);
        glBindVertexArray(vaoLeftRight);
        ...
        //triangle 2
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.0f, 0.0f));
        rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        worldMatrix = translationMatrix * rotationMatrix;
        glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
        ...
        // triangle 1
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-0.5f, 0.0f, 0.0f));
        rotationMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, -1.0f));
        worldMatrix = translationMatrix * rotationMatrix;
        glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
